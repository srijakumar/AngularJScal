...
(function () {
    ...
    app.controller('CalculatorController', ['$scope', function ($scope) {
        ...
        // save
        localStorage.setItem('environment', JSON.stringify($scope.environment))
        // load
        $scope.environment = JSON.parse(localStorage.getItem('environment'));
        ...
        var calculateKey = function calculateKey(key) {

            $scope.calculations[key] = calculate($scope.current_hours, 0, CONVERSION[key]);
        }


        var calculate = function calculate(hours, lumens, conversion) {
        ...
        $scope.calculate = function () {
           ...
           // if ($scope.current_hours < 1) { 
             //   $scope.current_hours = 1 
            //}

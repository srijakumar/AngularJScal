...
(function(){
    ...
    app.controller('CalculatorController',['$scope', function($scope){
        ...
        $scope.calculate = function(){
            ...
            $scope.calculations[key].wattage= function($scope.current_lumens,CONVERSIONS[key]){
                 $scope.current_lumens*CONVERSIONS[key];
            };
    
            $scope.calculations[key].cost= function($scope.calculations[key].wattage,$scope.total_days,$scope.current_hours,$scope.current_cost){
                ($scope.calculations[key].wattage*$scope.total_days*$scope.current_hours/1000)*($scope.current_cost/100).toFixed(2);
            };
